...
if (in_array($hash, $marks))
  {
  	header("location:exam_upload.php?status=virus");
  }
else
  {
  //echo "not found";
...
mysqli_query($con,"insert into sd_file (file,username,category) value ('$target_path','$_SESSION[login_user]','exam')");


header("location:exam_upload.php?a=1");
  }
  }
?>