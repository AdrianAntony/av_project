                    ...
                    <div class="col-md-8">
                        <div class="top-bar-left">
                            ...
                            <div class="text">
                                ...
                                <?php
                                switch ($page){
                                    case "ad_dashboard.php": echo "Services";
                                    break;

                                    case "staff_dashboard.php": echo "Services";
                                    break;

                                    case "student_details.php": echo "Students";
                                    break;

                                    case "student_form.php": echo "Add Student";
                                    break;

                                    case "staff_details.php": echo "Faculty";
                                    break;

                                    case "faculty_form.php": echo "Add Faculty";
                                    break;

                                    case "file_details.php": echo "All Files";
                                    break;

                                    case "stud_assignment_file_details.php": echo "Exam Portal";
                                    break;

                                    case "stud_assignment_file_detailsA.php": echo "Assignment Portal";
                                    break;

                                    case "documents.php": echo "All Documents";
                                    break;
