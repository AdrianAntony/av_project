        ...
        <div class="service mt-125">
            <div class="container">
                ...
                <div class="row">
				   ...
				   <form action='reginsertF.php' method='post' novalidate="novalidate">
				  ...
				  ?>
                            <div id="success"></div>
                              ...
                              <div class="control-group">
                                    <input type="text" class="form-control" id="name" name='mobile' placeholder="Enter Your Mobile" required="required" data-validation-required-message="Please enter your name" />
                                    <p class="help-block text-danger"></p>
                                </div>  


							   <div class="control-group">
                                    <input type="text" class="form-control" id="name" name='email_id' placeholder="Your Username" required="required" data-validation-required-message="Please enter your name" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
